...
public class RejectedOps_Adapter extends RecyclerView.Adapter<RejectedOps_Adapter.ViewChild> {
    ...
    public RejectedOps_Adapter(Context context, ArrayList<SaloonOPItem> users, SaloonOPS saloonOPS) {
    ...
    public ViewChild onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.saloon_rejected_ops_design, parent, false);
        return new RejectedOps_Adapter.ViewChild(view);
    }
